...
/*
 TypeScript raytracer by Microsoft
class Vector {
...
class RayTracer {
	...
	private testRay(ray: Ray, scene: Scene) {
		...
		if (isect != null) {
			...
			return undefined; // using std::numeric_limits<float>::infinity() instead
		}
	}
...
function defaultScene(): Scene {
    ...
    things: [new Plane(new Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkerboard),
			 new Plane(new Vector(10.0, 0.0, 0.0), 0.0, Surfaces.shiny),
